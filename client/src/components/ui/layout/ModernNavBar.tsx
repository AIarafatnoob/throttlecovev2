            ...
            {user ? (
              <div className="group relative">
                ...
                >
                  ...
                  <span className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-[10px] font-medium">
                    LOGOUT
                  </span>
                </Button>
              </div>
