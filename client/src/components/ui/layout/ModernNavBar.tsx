    ...
    <nav className="bg-white border-b border-gray-200 shadow-sm">
      <div className="container mx-auto px-4 py-3">
        <div className="flex justify-center relative">
          <div className="flex items-center bg-white rounded-full px-6 py-2 shadow-lg border border-gray-200">
                ...
                <Link
                  ...
                  className={`text-sm font-medium px-4 py-2 rounded-full transition-all duration-200 ${
                    location === link.path
                      ...
                      : "text-gray-600 hover:text-[#FF3B30] hover:bg-gray-50"
                  }`}
                >
                  {link.name}
                </Link>
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="border-gray-300 text-gray-600 hover:bg-[#FF3B30] hover:text-white hover:border-[#FF3B30]"
                >
                  Logout
                </Button>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Link href="/login">
                  <Button variant="ghost" size="sm" className="text-gray-600 hover:text-[#FF3B30]">
                    Login
                  </Button>
                </Link>
                <Link href="/register">
